...
local config = {
  ...
  mappings = {
    ...
    i = {
      ...
      ["jB}"] = { "<esc>F}i", desc = "Move to the previous '}'" },
      ["jB,"] = { "<esc>F,i", desc = "Move to the previous ','" },
      ["<m-j>"] = { "<esc>:w<cr>", desc = "Move down" },
      ["<m-k>"] = { "<esc>:w<cr>", desc = "Move up" },
      ["<m-h>"] = { "<esc>:w<cr>", desc = "Move left" },
      ["<m-l>"] = { "<esc>:w<cr>", desc = "Move right" },
      -- folding
      ["<localleader>nf"] = { ":set nofoldenable!<cr>", desc = "disable folds" },
      ["<localleader>fd"] = { ":set foldmethod=diff<cr>", desc = "Fold on diffs" },
      ...
      -- quitting insertion
      ["<c-s>"] = { "<esc>:w<cr>", desc = "Save the current buffer" },
    },
  },
